...
var maskerInstance = masker.NewMasker()
...
type Filter interface {
	...
	// MaskString is called when checking field and tag type. The return value is to be replaced. This method is intended for the case where you want to hide a part of a string.
...
func UpdateCustomMaskingChar(maskingCharacter masker.MaskinCharacter) {
	maskerInstance.UpdateMaskingCharacter(maskingCharacter)
}
